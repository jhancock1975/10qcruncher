...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="<c:url value="/resources/iridium/js/html5shiv.js" /> "></script><![endif]-->
		...
		<script src="<c:url value="/resources/iridium/js/init.js" /> "></script>
			...
			<link rel="stylesheet" href = "<c:url value="/resources/iridium/css/skel-noscript.css" /> " >
			<link rel="stylesheet" href = "<c:url value="/resources/iridium/css/style.css" /> " >
			<link rel="stylesheet" href = "<c:url value="/resources/iridium/css/style-desktop.css" /> " >
